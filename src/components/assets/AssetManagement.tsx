          ...
          <div className="bg-white rounded-lg p-4 mb-6 shadow-sm">
            <div className="flex flex-wrap items-center justify-between gap-4">
              ...
              >
                ...
                筛选
                <span className="ml-1 text-xs px-1.5 py-0.5 rounded-full bg-blue-50 text-blue-700">
                  {
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4 pt-4">
                <div>
                  ...
                  <select
                    ...
                    className="block w-full rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 bg-gray-50"
                  >
